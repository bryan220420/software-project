# Generated by Django 3.1.1 on 2020-10-05 03:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Caja',
            fields=[
                ('codCaja', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Tipo',
            fields=[
                ('codTipo', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Ingreso',
            fields=[
                ('codIng', models.IntegerField(primary_key=True, serialize=False)),
                ...
                ('codCaja', models.ForeignKey(db_column='codCaja', on_delete=django.db.models.deletion.CASCADE, to='T.caja')),
            ],
        ),
        migrations.AddField(
            model_name='empleado',
        ...
        migrations.CreateModel(
            name='Egreso',
            fields=[
                ('codEgr', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='caja',
            name='codPyto',
            field=models.ForeignKey(db_column='codPyto', on_delete=django.db.models.deletion.CASCADE, to='T.proyecto'),
        ),
        migrations.AddField(
            model_name='caja',
            name='codTipo',
            field=models.ForeignKey(db_column='codTipo', on_delete=django.db.models.deletion.CASCADE, to='T.tipo'),
        ),
        migrations.CreateModel(
            name='Tramo',
            fields=[
